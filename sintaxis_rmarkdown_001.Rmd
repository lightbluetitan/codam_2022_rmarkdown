...
**gapminder**[@gapminder] es un paquete del lenguaje de programación R, que contiene data proporcionada por [gapminder](http://gapminder.org){target=_blank}, que contiene un data set de 142 países; conformado por información de expectativas de vida;PBI per capita y población cada cinco años entre 1952 y 2007.

```{r gapminder,fig.align='center'}
...
```{python seaborn,fig.align="center",results='hide',collapse=TRUE}
